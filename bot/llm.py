...
Структура summary_ua (найважливіше) — 3-5 повних речень зв'язним текстом:
- СПЕРШУ суть новини з конкретикою: що саме сталося, хто/яка компанія, цифри
  (суми, відсотки, дати), деталі. НЕ переказуй лише заголовок.
- ПОТІМ — {summary_hint}.
- Якщо у вихідному тексті мало деталей — усе одно витисни максимум суті, але
  не вигадуй фактів, яких немає.
- Українською, живо та змістовно, без markdown, без списків.
